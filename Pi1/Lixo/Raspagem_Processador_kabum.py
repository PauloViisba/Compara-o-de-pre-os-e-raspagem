...
driver.get("https://www.kabum.com.br/hardware/processadores")
...
# Inicializando a lista para armazenar URLs das imagens
Precos_processador = []
Nomes_processador = []
urls_imagens = []
precos_limpos = []
...
for nome, preco, imagem_url in zip(Nomes_processador, precos_limpos, urls_imagens):
    ...
    cursor.execute("INSERT INTO produto (Nome, Marca, Preco, Site, Imagem) VALUES (%s, %s, %s, %s, %s)", (nome, marca, preco, 'Kabum', imagem_url))
    mydb.commit()
