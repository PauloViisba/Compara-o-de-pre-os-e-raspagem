...
for span in link_processador:
    Links_processador.append(span['href'])  # Aqui extraímos o atributo href diretamente
...
for nome, preco, imagem_url, link in zip(Nomes_processador, precos_limpos, urls_imagens, Links_processador):
    ...
    cursor.execute("INSERT INTO produto (Nome, Marca, Preco, Site, Imagem, Data, Link) VALUES (%s, %s, %s, %s, %s, %s, %s)",(nome, marca, preco, 'Terrabyte', imagem_url, '2024-05-23', link))
    mydb.commit()
